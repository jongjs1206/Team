...
<meta charset="UTF-8">
<title>회원가입</title>
<link rel="stylesheet" href="./resources/css/userjoin_css/join_step2.css">
<script src="resources/js/vendor/jquery-3.5.1.min.js"></script>
<script src="resources/js/join_step2.js"></script>
...
<div class="contents">
			...
			<div class="member">
				<div class="join">
					<form name="joinform" method="post" action="./join_step3.do" onSubmit="return join_chk();" autocomplete='off'>
...
<!-- 										<span class="info">8-16자:영문,숫자조합</span> -->
										<input id = "user_id" type="text" class=" placeholder" placeholder="4-20자: 영문 소문자,숫자조합" name="u_id" title="아이디를 입력하세요" autocomplete='new-password'>
									</p>
								...
								<li>
									<p class="tit">이름</p>
									<p class="form">
										<input type="text" name="u_name" title="이름을 입력하세요" autocomplete='new-password'>
									</p>
								</li>
								<li>
									<p class="tit">휴대전화</p>
									...
									<p class="caution caution_cell" style="padding-top: 1px;">※숫자만 입력 가능합니다.</p>
								...
								<li>
									...
									<p class="form" id="size">
										<label>키<input type="text" maxlength="3" name="u_height" title="키" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></label>
										<label>몸무게<input type="text" maxlength="3" name="u_weight" title="몸무게" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></label>
									</p>
								</li>
								<li>
									<p class="tit">생일</p>
							...
							<li>
								...
								<ul class="btnbox">
									...
									<li><button type="button" class="btn-m-line"
											onclick="javascript:location.href='./login.do'">
											<span>취소</span>
										</button></li>
								</ul></fieldset>
					</form>
